      ...
      <main className="co-main">
        ...
        <div className="co-hero">
          ...
          <div className="co-hero-left">
            <div className="co-hero-icon" aria-hidden="true"><Icon.FilePlus /></div>
            <div>
              <h2 className="co-hero-title">Add New Contract</h2>
              <p className="co-hero-subtitle">Fill in the details below to create a new contract</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="co-form-card">
            ...
            <div className="co-form-actions">
              <button className="co-btn co-btn-primary" type="submit" disabled={loading}>
                {loading ? (
                  <><span className="co-spinner" style={{ width: 16, height: 16, borderWidth: 2, margin: 0, display: 'inline-block' }} />Adding…</>
                ) : (
                  <><Icon.Plus />Add Contract</>
                )}
              </button>
              <button className="co-btn co-btn-ghost" type="button" onClick={() => navigate('/contracts')} disabled={loading}>
                Cancel
              </button>
            </div>
          </div>
